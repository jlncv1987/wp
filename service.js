...
const confirmSentMessageWp = async (_json) => {
    return api.executeDatatable("USP_MEDIOCONTACTO_WHATSAPP_CONFIRMA",{json});
}

const getWBPending = async (debug=false) => api.executeDatatable("USP_SEL_WHATSAPP",{debug})
